    ...
    render () {
        return (
            <div>
                <Header />
                <MetaData 
                    title="Piscine -restaurant restau fès sidi harazem menzeh manzeh manzah menzah café piscine Resto- la piscine" 
                    meta={[
                        { name: "robots", content: "index,follow" },
                        { name: "description", content: "La piscine Menzah Sidi Harazem et la seule piscine destinée que pour les femmes à Fès. Pour vivre des moment inoubliable en famille." }
                    ]}
                />
