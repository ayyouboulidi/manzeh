    ...
    render () {
        return (
            <div>
                <Header />
                <MetaData 
                    title="Carte - restaurant restau fès sidi harazem menzeh manzeh manzah menzah café piscine Resto - les prix à la carte" 
                    meta={[
                        { name: "robots", content: "index,follow" },
                        { name: "description", content: "La carte - menu - du restaurant menzah Sidi Harazem, le meilleur restaurant de la région de Fès Sidi Harazem" }
                    ]}/>
